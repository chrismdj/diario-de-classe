...
// const addDateButton = document.getElementById('addDateButton'); // <<< REMOVIDO
...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    // addDateButton.addEventListener('click', addDate); // <<< LISTENER REMOVIDO
